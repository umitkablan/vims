...
syn match spellingException "\<\w*\d[\d\a]*\>"      transparent contained containedin=shComment,sh.*String contains=@NoSpell
...
syn match spellingException "\w\+[\-_.]\w\+"        transparent contained containedin=shComment,sh.*String contains=@NoSpell
