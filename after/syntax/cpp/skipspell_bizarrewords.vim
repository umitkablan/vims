...
syn match spellingException "\<\w*\d[\d\a]*\>"      transparent contained containedin=cComment,c.*String contains=@NoSpell
...
syn match spellingException "\w\+[\-_.]\w\+"        transparent contained containedin=cComment,c.*String contains=@NoSpell
