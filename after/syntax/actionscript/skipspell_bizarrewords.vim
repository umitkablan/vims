...
syn match spellingException "\<\w*\d[\d\w]*\>"      transparent contained containedin=actionScriptComment,actionScriptStringS,actionScriptStringD contains=@NoSpell
...
syn match spellingException "\S*[/\\_`]\S*"         transparent contained containedin=actionScriptComment,actionScriptStringS,actionScriptStringD contains=@NoSpell
syn match spellingException "\S\+-\S*"              transparent contained containedin=actionScriptComment,actionScriptStringS,actionScriptStringD contains=@NoSpell
