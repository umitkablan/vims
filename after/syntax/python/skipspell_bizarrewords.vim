...
syn match spellingException "\<\w*\d[\d\a]*\>"      transparent contained containedin=pythonComment,python.*String contains=@NoSpell
...
syn match spellingException "\w\+[\-_.]\w\+"        transparent contained containedin=pythonComment,python.*String contains=@NoSpell
