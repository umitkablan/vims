...
SpitVspit/
TaskMotions/
addon-actions-33dec26-MarcWeber-vim/
autocomplpop/
bestfriend/
command-t-1.3.1/
dfrank_util/
...
fuzzee-vim/
golden-ratio/
gtk-mode-5ebe37e-vim-scripts/
indexer/
lh-cpp-read-only/
lh-dev-read-only/
lh-map-tools-read-only/
lh-refactor-read-only/
notes/
pomodoro-vim/
powerline-Lokaltog-vim/
prettyprint-0.3.2/
pythoncomplete/
sauce/
selectbuf-4.3/
simple_bookmarks/
sleuth/
space-9440e38-spiiph-vim/
spacebox/
statline-umt/
submode-0.0.0-vim/
tabpagecolorscheme-1.3/
tinymode/
unite-font-1.3/
vimprj/
vimsh/
