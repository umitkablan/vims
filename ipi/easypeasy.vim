...
" GLOBALS
"===============================================================================
let g:tag_directory = ".vimprj/easypeasytags/"
let g:tag_extension = ".tags"
let g:lvimrc_filename = "easypeasy.vim"
let g:include_paths = ""
...
function! GenerateIncludes()
	...
	if filereadable(s:cwd . "/.vimprj/" . g:lvimrc_filename)
		if delete(s:cwd . "/.vimprj/" . g:lvimrc_filename) != 0
	...
	call writefile(generator.lib_tags, s:cwd . "/.vimprj/" . g:lvimrc_filename)
