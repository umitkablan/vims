...
let g:xolox#easytags#lastupdate_i = 0
    ...
    if a:event =~? 'cursorhold'
      ...
      if &updatetime < updatetime_min
        ...
        if xolox#misc#option#get('easytags_updatetime_autodisable', exists('g:loaded_neocomplcache'))
          if g:xolox#easytags#lastupdate_i < updatetime_min
            let g:xolox#easytags#lastupdate_i = g:xolox#easytags#lastupdate_i + &updatetime
            return
          else
            "echomsg "success to top.......easytags"
            let g:xolox#easytags#lastupdate_i = 0
          endif
        else
