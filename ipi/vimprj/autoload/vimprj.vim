...
function! vimprj#init()
   ...
   if !exists('g:vimprj_alwaysApplyExecSettings')
      let g:vimprj_alwaysApplyExecSettings = 0
   endif
...
function! <SID>ExecHooks(sHooksgroup, dParams)
   ...
   for l:sKey in keys(g:vimprj#dHooks[ a:sHooksgroup ])
      ...
      if !has_key(l:dParams, 'dVimprjRootParams')
         continue
      endif
...
function! <SID>GetVimprjRootOfFile(iFileNum)
   ...
   while (l:i < g:vimprj_recurseUpCount)
      ...
      if isdirectory(l:sTmp) || filereadable(l:sTmp)
         ...
         let l:stmproot = simplify(l:sDirname.l:sCurPath)
         break
...
function! <SID>OnFileOpen(iFileNum)
   ...
   if !has_key(g:vimprj#dRoots, l:sVimprjKey)
      ...
      if l:sVimprjKey != g:vimprj#sCurVimprjKey || g:vimprj_alwaysApplyExecSettings
...
function! <SID>OnBufEnter(iFileNum)
   ...
   if l:sPrevVimprjKey != g:vimprj#sCurVimprjKey || g:vimprj_alwaysApplyExecSettings
