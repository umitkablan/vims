...
function! s:Tabops__defineCommandsOnStartup()
    ...
    let s:Tabops__commandTree = {
                ...
                \ , 'Swap' : {
                    \   'Right' : function('s:Tabops__swapNext')
                    \ , 'Left' : function('s:Tabops__swapPrev')
                    \ }
                \ }
endfunction
...
function! s:Tabops_onBufEnter()
    noremap  <silent>  <Tab><Tab>l   :tabnext<CR>
    noremap  <silent>  <Tab><Tab>h   :tabprev<CR>
    if g:Tabops_useGoto
...
function! s:Tabops__enableCtrlGoto()
    ...
    "noremap  <silent>  <Tab><Backspace> :tabprevious<CR>
endfunction
