...
"===================================================================
"Default map:
if ("" == maparg("<Leader><Leader>s", "n"))
    nmap <script> <silent> <unique> <Leader><Leader>s <ESC>:TSearch <cword> <CR>
endif
if ("" == maparg("<Leader><Leader>s", "v"))
    vmap <script> <silent> <unique> <Leader><Leader>s y<ESC>:TSearch <c-r>" <CR>
endif
if ("" == maparg("<Leader><Leader>f", "n"))
    nmap <script> <silent> <unique> <Leader><Leader>f <ESC>:TFind <cword> <CR>
endif
if ("" == maparg("<Leader><Leader>f", "v"))
    vmap <script> <silent> <unique> <Leader><Leader>f y<ESC>:TFind <c-r>" <CR>
endif
if ("" == maparg("<Leader><Leader>g", "n"))
    nmap <script> <silent> <unique> <Leader><Leader>g <ESC>:TGoto <CR>
endif
if ("" == maparg("<Leader><Leader>g", "v"))
    vmap <script> <silent> <unique> <Leader><Leader>g y<ESC>:TGoto <c-r>" <CR>
endif
if ("" == maparg("<Leader><Leader>h", "n"))
    nmap <script> <silent> <unique> <Leader><Leader>h yaw<ESC>:TBMatch @\" <CR>
endif
if ("" == maparg("<Leader><Leader>h", "v"))
    vmap <script> <silent> <unique> <Leader><Leader>h y<ESC>:TBMatch @\" <CR>
endif
if ("" == maparg("*", "v"))
