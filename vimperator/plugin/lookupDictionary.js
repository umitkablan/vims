...
const SITE_DEFINITION = [{
    ...
    names: ['ss[dictionary]'],
    //url: 'http://www.seslisozluk.com/?word=%s',
    url: 'http://zargan.com/sozluk.asp?Sozcuk=%s',
    shortHelp: 'Zargan dict.',
    xpath: '//*/div[@class="res"]',
    multi: true,
    dictionary: 'en-US'
},{
    ...
    names: ['wikitr'],
    url: 'http://tr.wikipedia.org/wiki/%s',
    shortHelp: 'Wikipedia lite(tr)',
